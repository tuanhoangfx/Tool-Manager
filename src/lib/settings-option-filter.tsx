...
import { HubSingleFilterDropdown, SettingsSubsection, type FilterOption } from "@tool-workspace/hub-ui";
import { compactIconSize } from "./ui-scale";

type SettingsOptionFilterProps<T extends string | number> = {
  title: string;
  icon: LucideIcon;
...
/** Settings — section title + value-only filter on one header row (F1). */
