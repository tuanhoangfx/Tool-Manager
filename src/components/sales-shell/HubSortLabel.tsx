...
export function HubSortLabel({ label }: { label: string }) {
  return (
    <span
      className="inline-flex h-[34px] shrink-0 items-center gap-1.5 rounded-lg border border-violet-500/30 bg-violet-500/10 px-3 text-xs font-medium text-violet-100 shadow-sm shadow-violet-500/10"
