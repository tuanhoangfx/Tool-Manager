...
export function NoteCookieSnapshotBlock({ lines, syncStatus, syncedAt, bodyMd, onInsertIntoMarkdown }: Props) {
  ...
  return (
    <section className="fm-cookie-panel">
      ...
      <p className="fm-cookie-panel__hint">
        Extension sync fills <strong>cookie snapshot</strong> (masked values). Markdown below is your note content — optional.
      </p>
