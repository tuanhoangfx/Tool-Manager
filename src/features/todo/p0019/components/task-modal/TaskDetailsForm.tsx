        ...
        <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-4">
                 <div className="flex flex-col">
                    <label className="hidden md:block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t.project}</label>
                    <MultiSelectDropdown
                ...
                <div className={`flex flex-col ${validationError === 'assignee' ? 'ring-2 ring-red-500/50 rounded-md animate-shake' : ''}`}>
                    <label className="hidden md:block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t.assignee}</label>
                    <MultiSelectDropdown
                ...
                <div>
                    <label htmlFor="dueDate" className="hidden md:block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t.dueDateLabel}</label>
                ...
                <div>
                    <label className="hidden md:block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t.priority}</label>
