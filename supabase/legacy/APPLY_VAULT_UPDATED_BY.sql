-- Optional: separate updated_by column. Extension v0.5.17+ works WITHOUT this (uses source_browser).
-- Run only if you want updated_by distinct from source_browser.
