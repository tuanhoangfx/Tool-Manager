-- Only bump notes.synced_at when extension explicitly requests it (manual Sync per route).
-- Stops schema probes / accidental RPC calls from mass-updating sync timestamps.
